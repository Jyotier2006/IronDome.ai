...
class IPManager:
    ...
    def record_brute_force_blocked(
        self,
        ip: str,
        endpoint: str,
        method: str,
        ...
        """Record a brute-force attempt detected outside the live HTTP path (e.g. from the telemetry rule engine)"""
        self._record_dropped_packet(
            source_ip=ip,
            attack_type="brute_force",
            reason="blocked",
    ...
    def record_flooding_blocked(
        ...
        """Record a flood/DDoS burst detected outside the live HTTP path (e.g. from the telemetry rule engine)"""
        self._record_dropped_packet(
            source_ip=ip,
            attack_type="flooding",
            reason="blocked",
