...
from defense_playbook_executor import (
    run_playbook,
    get_blocked_ips,
...
async def get_status():
    from defense_playbook_executor import throttled_ips
    return {
...
async def manual_block_ip(ip: str, duration: int = 600, reason: str = "manual"):
    ...
    from defense_playbook_executor import blocked_ips
...
async def manual_isolate_service(service: str):
    from defense_playbook_executor import isolated_services
